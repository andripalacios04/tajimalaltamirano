...
<?php if (function_exists('retame_render_shell')) { retame_render_shell('Perfil de Usuario - RETAME'); } ?>
    ...
    <div class="main-content">
        ...
        <div class="perfil-card">
            <h2>Hola <?php echo $Nombre; ?>, ¿A quién vas a retar hoy?</h2>
            
            <div class="main-buttons-grid">
                <button class="circle-btn" onclick="location.href='CrearEquipo_Temporal.php'">
                    Crear<br><span>equipo</span>
                </button>
                <button class="circle-btn" onclick="location.href='UnirmeEquipo_Temporal.php'">
                    Unirme a<br><span>un equipo</span>
                </button>
            </div>
            
            <div class="bottom-buttons">
                <button class="bottom-btn" onclick="location.href='Equipo/CrearEquipo.php'">
                    Crear<br><span>equipo fijo</span>
                </button>
                <button class="bottom-btn" onclick="location.href='registrar_instalacion.php'">
                    Registrar<br><span>instalación</span>
                </button>
                <button class="bottom-btn" onclick="location.href='registrar_deporte.php'">
                    Registrar<br><span>deporte</span>
                </button>
            </div>
        </div>
    </div>
